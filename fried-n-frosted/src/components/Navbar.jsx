...
const Navbar = () => {
    ...
    const navItems = <>
        <li><a className='text-orange' href='/'>Home</a></li>
        <li><a className='text-black' href='/menu'>Menu</a></li>
        {/* <li tabIndex={0}>
            <details>
        ...
        <header className='max-w-screen-2xl container mx-auto fixed top-0 left-0 right-0 transition-all duration-300 ease-in-out' style={{ zIndex: 10001 }}>
            <div className={`navbar xl:px-24 ${isSticky ? "shadow-md bg-base-100 transition-all duration-300 ease-in-out" : ""}`}>
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-2xl w-24 h-24" href='/'><img src={FAF} alt="" /></a>
                </div>
                ...
                <div className="navbar-end">
                    ...
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle mr-3 lg:flex hidden items-center justify-center">
                        <div className="indicator">
                            ...
                            <span className="bg-orange text-white badge badge-sm indicator-item">{cart.length || 0}</span>
                        </div>
                    </div> 
                    </Link>
                    {
                        ...
                        className="btn bg-orange rounded-full px-6 text-white flex items-center gap-2"><FaRegUser />Login
                    </button>
                    }
                    <Modal/>
                </div>
