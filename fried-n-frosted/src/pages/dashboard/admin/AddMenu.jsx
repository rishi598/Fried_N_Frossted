...
const AddMenu = () => {
    ...
    return (
        <div className='w-full md:w-[870px] px-4 mx-auto'>
            <h2 className='text-2xl font-semibold my-4'>Upload a New <span className='text-orange'>Menu Item</span></h2>
            {/** form */}
            <div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <button className='btn bg-orange text-white px-6'>Add Item<FaUtensils/></button>
                </form>
            </div>
        </div>
    )
